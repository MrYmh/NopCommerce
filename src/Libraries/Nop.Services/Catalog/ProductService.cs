...
namespace Nop.Services.Catalog
{
    ...
    public partial class ProductService : IProductService
    {
        ...
        public async Task<IList<Product>> GetProductsByCategoryIdsAsync(IEnumerable<int> categoriesIds)
        {
            var products = await _productCategoryRepository.GetAllAsync(query => query.Where(x => categoriesIds.Contains(x.CategoryId)));
