...
namespace Nop.Services.Catalog
{
    ...
    public partial class ProductAttributeParser : BaseAttributeParser, IProductAttributeParser
    {
        ...
        public async Task<string> ConvertAttributesToString(string attributeXml)
        {
            try
            {
                var productAttributeValues = await ParseProductAttributeValuesAsync(attributeXml);
                var attributeValues = productAttributeValues.Select(x => x.Name);
