...
namespace Nop.Web.Framework.Infrastructure
{
    ...
    public partial class NopStartup : INopStartup
    {
        ...
        public virtual void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            //Warehouse Services
            services.AddScoped<IAcceptStockRequestService, AcceptStockRequestService>();
            services.AddScoped<IStockRequestItemService, StockRequestItemService>();
            services.AddScoped<IShelfItemMappingService, ShelfItemMappingService>();
            services.AddScoped<IShelfService, ShelfService>();
            services.AddScoped<IStockHistoryService, StockHistoryService>();
            services.AddScoped<IStockItemHistoryService, StockItemHistoryService>();
            services.AddScoped<IStockRequestService, StockRequestService>();
            services.AddScoped<IWarehouseCategoryMappingService, WarehouseCategoryMappingService>();
            ...
            services.AddScoped<IWarehouseProductCategoryMappingService, WarehouseProductCategoryMappingService>();
            services.AddScoped<IWarehouseProductCombinationService, WarehouseProductCombinationService>();
            services.AddScoped<IWarehouseProductService, WarehouseProductService>();
            services.AddScoped<IWarehouseStandService, WarehouseStandService>();
