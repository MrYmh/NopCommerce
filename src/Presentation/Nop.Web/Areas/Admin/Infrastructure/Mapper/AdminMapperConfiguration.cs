...
namespace Nop.Web.Areas.Admin.Infrastructure.Mapper
{
    ...
    public partial class AdminMapperConfiguration : Profile, IOrderedMapperProfile
    {
        ...
        public AdminMapperConfiguration()
        {
            ...
            CreateWarehouseProductCombinationMaps();
            CreateWarehouseItemMaps();
            CreateShelfItemMappingMaps();
            CreateStockRequestMaps();
            CreateStockRequestItemMaps();
            CreateAcceptStockRequestMaps();
            CreateStockHistoryMaps();
            CreateStockItemHistoryMaps();
            CreateWarehouseStandMaps();
            CreateShelfMaps();
            CreateWarehouseCategoryMappingMaps();
            CreateWarehouseProductCategoryMappingMaps();
            CreateWarehouseCategoryMaps();
            CreateStockHistoryMaps2();
        ...
        protected virtual void CreateWarehouseMaps()
        {
            ...
            CreateMap<WarehouseCategory, WarehouseCategoryModel>();
            CreateMap<WarehouseCategoryModel, WarehouseCategory>();
        }

        /// <summary>
        /// Create warehouse product maps 
        /// </summary>
        protected void CreateWarehouseProductMaps()
        {
            CreateMap<WarehouseProduct, WarehouseProductModel>();
            CreateMap<WarehouseProductModel, WarehouseProduct>();
            CreateMap<Product, WarehouseProductDto>();
            CreateMap<WarehouseProductDto, Product>();
        }

        /// <summary>
        /// Create warehouse product combination maps 
        /// </summary>
        protected void CreateWarehouseProductCombinationMaps()
        {
            CreateMap<WarehouseProductCombination, WarehouseProductCombinationModel>();
            CreateMap<WarehouseProductCombinationModel, WarehouseProductCombination>();
        }

        /// <summary>
        /// Create warehouse item maps 
        /// </summary>
        protected void CreateWarehouseItemMaps()
        {
        ...
        /// <summary>
        /// Create shelf item mapping maps 
        /// </summary>
        protected void CreateShelfItemMappingMaps()
        {
            CreateMap<ShelfItemMapping, ShelfItemMappingModel>();
            CreateMap<ShelfItemMappingModel, ShelfItemMapping>();
        }

        /// <summary>
        /// Create stock request maps 
        /// </summary>
        protected void CreateStockRequestMaps()
        {
            CreateMap<StockRequest, StockRequestModel>();
            CreateMap<StockRequestModel, StockRequest>();
        }

        /// <summary>
        /// Create stock request item maps 
        /// </summary>
        protected void CreateStockRequestItemMaps()
        {
            CreateMap<StockRequestItem, StockRequestItemModel>();
            CreateMap<StockRequestItemModel, StockRequestItem>();
        }

        /// <summary>
        /// Create accept stock request maps 
        /// </summary>
        protected void CreateAcceptStockRequestMaps()
        {
            CreateMap<AcceptStockRequest, AcceptStockRequestModel>();
            CreateMap<AcceptStockRequestModel, AcceptStockRequest>();
        }

        /// <summary>
        /// Create stock history maps 
        /// </summary>
        protected void CreateStockHistoryMaps()
        {
        ...
        /// Create stock history maps 
        /// </summary>
        protected void CreateStockHistoryMaps2()
        {
            CreateMap<StockRequest, StockHistoryModel>();
            CreateMap<StockHistoryModel, StockRequest>();

            CreateMap<StockRequestItem, StockItemHistoryModel>();
            CreateMap<StockItemHistoryModel, StockRequestItem>();

        }

        /// <summary>
        /// Create stock item history maps 
        /// </summary>
        protected void CreateStockItemHistoryMaps()
        {
            CreateMap<StockItemHistory, StockItemHistoryModel>();
            CreateMap<StockItemHistoryModel, StockItemHistory>();
        }

        /// <summary>
        /// Create warehouse stand maps 
        /// </summary>
        protected void CreateWarehouseStandMaps()
        {
            CreateMap<WarehouseStand, WarehouseStandModel>();
            CreateMap<WarehouseStandModel, WarehouseStand>();
        }

        /// <summary>
        /// Create shelf maps 
        /// </summary>
        protected void CreateShelfMaps()
        {
        ...
        /// <summary>
        /// Create warehouse category mapping maps 
        /// </summary>
        protected void CreateWarehouseCategoryMappingMaps()
        {
            CreateMap<WarehouseCategoryMapping, WarehouseCategoryMappingModel>();
            CreateMap<WarehouseCategoryMappingModel, WarehouseCategoryMapping>();
        }

        /// <summary>
        /// Create warehouse product category mapping maps 
        /// </summary>
        protected void CreateWarehouseProductCategoryMappingMaps()
        {
            CreateMap<WarehouseProductCategoryMapping, WarehouseProductCategoryMappingModel>();
            CreateMap<WarehouseProductCategoryMappingModel, WarehouseProductCategoryMapping>();
        }

        /// <summary>
        /// Create warehouse category maps 
        /// </summary>
        protected void CreateWarehouseCategoryMaps()
        {
            CreateMap<WarehouseCategory, WarehouseCategoryModel>();
            CreateMap<WarehouseCategoryModel, WarehouseCategory>();
        }
