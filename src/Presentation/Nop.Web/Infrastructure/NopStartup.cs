...
namespace Nop.Web.Infrastructure
{
    ...
    public partial class NopStartup : INopStartup
    {
        ...
        public virtual void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            //warehouse factories
            services.AddScoped<IWarehouseStandModelFactory, WarehouseStandModelFactory>();
            services.AddScoped<IWarehouseProductModelFactory, WarehouseProductModelFactory>();
            services.AddScoped<IWarehouseProductCombinationModelFactory, WarehouseProductCombinationModelFactory>();
            services.AddScoped<IWarehouseProductCategoryMappingModelFactory, WarehouseProductCategoryMappingModelFactory>();
            services.AddScoped<IWarehouseItemModelFactory, WarehouseItemModelFactory>();
            services.AddScoped<IWarehouseCategoryModelFactory, WarehouseCategoryModelFactory>();
            services.AddScoped<IWarehouseCategoryMappingModelFactory, WarehouseCategoryMappingModelFactory>();
            services.AddScoped<IStockRequestModelFactory, StockRequestModelFactory>();
            services.AddScoped<IStockRequestItemModelFactory, StockRequestItemModelFactory>();
            services.AddScoped<IStockItemHistoryModelFactory, StockItemHistoryModelFactory>();
            services.AddScoped<IStockHistoryModelFactory, StockHistoryModelFactory>();
            //services.AddScoped<IStockItemHistoryMappingModelFactory, StockItemHistoryMappingModelFactory>();
            services.AddScoped<IShelfModelFactory, ShelfModelFactory>();
            services.AddScoped<IStockHistoryModelFactory, StockHistoryModelFactory>();
            services.AddScoped<IShelfModelFactory, ShelfModelFactory>();
            services.AddScoped<IShelfItemMappingModelFactory, ShelfItemMappingModelFactory>();
            services.AddScoped<IAcceptStockRequestModelFactory, AcceptStockRequestModelFactory>();
            ...
            services.AddScoped<IStockItemHistoryMappingService, StockItemHistoryMappingService>();
